    ...
    "Common Lisp CL-JSON":
        {
            ...
            "commands":[os.path.join(BASE_DIR, "parser"), "cl-json"]
        },
    "Common Lisp Jonathan":
        {
            "url":"https://github.com/Rudolph-Miller/jonathan",
            "commands":[os.path.join(BASE_DIR, "parser"), "jonathan"]
        },
    "Common Lisp json-streams":
        {
            "url":"https://github.com/rotatef/json-streams",
            "commands":[os.path.join(BASE_DIR, "parser"), "json-streams"]
        },
    "Common Lisp jsown":
        {
            "url":"https://github.com/madnificent/jsown",
            "commands":[os.path.join(BASE_DIR, "parser"), "jsown"]
        },
    "Common Lisp jzon":
        {
            "url":"https://github.com/Zulu-Inuoe/jzon",
            "commands":[os.path.join(BASE_DIR, "parser"), "jzon"]
        },
    "Common Lisp RS-JSON":
        {
            "url":"https://github.com/ralph-schleicher/rs-restless",
            "commands":[os.path.join(BASE_DIR, "parser"), "rs-json"]
        },
    "Common Lisp shasht":
        {
            "url":"https://github.com/yitzchak/shasht",
            "commands":[os.path.join(BASE_DIR, "parser"), "shasht"]
        },
    "Common Lisp ST-JSON":
        {
            "url":"https://github.com/marijnh/ST-JSON",
            "commands":[os.path.join(BASE_DIR, "parser"), "st-json"]
        },
    "Common Lisp YASON":
        {
            "url":"https://github.com/phmarek/yason",
            "commands":[os.path.join(BASE_DIR, "parser"), "yason"]
        },
}
...
#       libs.sort()
        ...
        """)
    if os.path.exists('/usr/bin/open') and False:
